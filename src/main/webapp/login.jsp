					...
					<div class="auth-inner row m-0">
						...
						<div
							...
							<div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
								...
								<p class="card-text mb-2">Por favor, ingrese su correo y
									contraseña.</p>

								<form class="auth-login-form mt-2" action="Auth" method="POST">
									<input type="hidden" name="accion" id="accion" value="INICIAR_SESION"/>
									<div class="mb-1">
										<label class="form-label" for="login-email">Correo
											Electrónico</label> <input class="form-control" id="login-email"
											type="text" name="login-email"
											placeholder="jreyes@setours.com"
											aria-describedby="login-email" autofocus="" tabindex="1" />
									</div>
									<div class="mb-1">
										<div class="d-flex justify-content-between">
											<label class="form-label" for="login-password">Contraseña</label>
											<a href="reestablecer.jsp"> <small>¿Olvidó su
													contraseña?</small>
											</a>
										</div>
										<div
											...
											<input class="form-control form-control-merge"
												id="login-password" type="password" name="login-password"
									...
									<button class="btn btn-primary w-100" tabindex="4"
										type="submit" id="btnLogin" name="btnLogin">Iniciar
										Sesión</button>
								</form>
								<%
