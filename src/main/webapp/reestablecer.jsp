	                    ...
	                    <div class="auth-inner row m-0">
	                        ...
	                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
	                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
	                                ...
	                                <p class="card-text mb-2">Por favor, ingrese su correo electrónico.</p>
	                                <form class="auth-forgot-password-form mt-2" action="AuthController" method="POST">
	                                    <div class="mb-1">
	                                        <label class="form-label" for="forgot-password-email">Correo Electrónico</label>
	                                        <input class="form-control" id="forgot-password-email" type="text" name="forgot-password-email" placeholder="jreyes@setours.com" aria-describedby="forgot-password-email" autofocus="" tabindex="1" />
	                                    </div>
