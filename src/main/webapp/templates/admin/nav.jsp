...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow"
	...
	<div class="navbar-header">
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item me-auto"><a class="navbar-brand"
				href="main.jsp"> <span class="brand-logo"> <%@ include
							file="/templates/global/svg-image.jsp"%>
				</span>
					<h2 class="brand-text">SETRA</h2>
			</a></li>
			<li class="nav-item nav-toggle"><a
				class="nav-link modern-nav-toggle pe-0" data-bs-toggle="collapse">
	...
	<div class="main-menu-content">
		<ul class="navigation navigation-main" id="main-menu-navigation"
			...
			<!-- 
        	<li class="nav-item">
                 <a class="d-flex align-items-center" href="main.jsp">
